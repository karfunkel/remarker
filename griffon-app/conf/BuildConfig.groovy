...
griffon {
    doc {
        ...
        sponsorLogo = "<br/>"
        footer = "<br/><br/>Made with Griffon (0.9.5-rc2)"
    }
}
...
deploy {
    application {
        ...
        homepage = 'http://localhost/Remarker'
        description {
            complete = 'Remarker 0.1'
            oneline  = 'Remarker 0.1'
            minimal  = 'Remarker 0.1'
            tooltip  = 'Remarker 0.1'
        }
        icon {
            'default' {
...
app.fileType = '.groovy'
app.defaultPackageName = 'remarker'
